...
public class EmployeeDetailsService {
    ...
    private EmployeeDetails updateDetails(EmployeeDetails oldDetails,
    ...
    public void save(Long employeeId, EmployeeDetails employeeDetails) {
        Optional<Employee> foundEmployee = employeeRepository.findById(
            employeeId);
        if (foundEmployee.isPresent()) {
            ...
            if (oldEmployeeDetails != null) {
                EmployeeDetails updatedDetails = updateDetails(
                    oldEmployeeDetails, employeeDetails);
            ...
            throw new IllegalArgumentException(
                "Unable to find user with id: " + employeeId);
        }
    }
}
